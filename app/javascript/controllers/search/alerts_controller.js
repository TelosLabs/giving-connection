  ...
  submitForm() {
    ...
    Rails.ajax({
      ...
      success: function(data) {
        let alert = `<div class="flash-success bg-blue-50 fixed z-10 inset-x-2 top-24 rounded-md p-4 max-w-ms mx-auto" data-alert--component-target="notification" data-controller="alert--component">

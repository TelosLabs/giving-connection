        ...
        let alert = `<div class="flash-success bg-green-50 fixed z-40 inset-x-2 top-24 rounded-md p-4 max-w-lg mx-auto" data-alert--component-target="notification" data-controller="alert--component">
                      <div class="flex items-center">
                        <div class="flex-shrink-0">
                          ...
                          <p class="text-sm font-medium text-green-800">Alert created successfully! Go to My Account to view or edit.</p>
                        </div><div class="pl-3 ml-auto">
                          <div class="-mx-1.5 -my-1.5">
                            <button class="inline-flex rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 p-1.5 bg-green-50 text-green-500 hover:bg-green-100 focus:ring-offset-green-50 focus:ring-green-600" data-action="alert--component#closeAlert" type="button">
        ...
        let alert = `<div class="flash-success bg-green-50 fixed z-40 inset-x-2 top-24 rounded-md p-4 max-w-ms mx-auto" data-alert--component-target="notification" data-controller="alert--component">
                      <div class="flex items-center">
                        <div class="flex-shrink-0">
                          ...
                          <p class="text-sm font-medium text-green-800">Alert updated!</p>
                        </div><div class="pl-3 ml-auto">
                          <div class="-mx-1.5 -my-1.5">
                            <button class="inline-flex rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 p-1.5 bg-green-50 text-green-500 hover:bg-green-100 focus:ring-offset-green-50 focus:ring-green-600" data-action="alert--component#closeAlert" type="button">
                              <span class="sr-only">Dismiss</span>

...
module Organizations
  module Constants
    ...
    NTEE_CODE = [
                ...
                "A53: Folk Arts Museums<i>(Draft Code - not for internal IRS use)</i>", 
                "A54: History Museums", 
                ...
                "Q34: International Educational Development <i>(Draft Code - not for internal IRS use)</i>", 
                "Q35: International Democracy & Civil Society Development", 
                "Q36: International Science & Technology Development <i>(Draft Code - not for internal IRS use)</i>", 
                "Q38: International Environment Population & Sustainability <i>(Draft Code - not for internal IRS use)</i>", 
                "Q39: International Health Development <i>(Draft Code - not for internal IRS use)</i>", 
                ...
                "R19: Support N.E.C.", 
                "R20: Civil Rights", 
                "R21: Immigrants' Rights<i>(Draft Code - not for internal IRS use)</i>", 
                "R22: Minority Rights", 
                "R23: Disabled Persons Rights", 
                "R24: Womens Rights", 
                "R25: Seniors Rights", 
                "R26: Lesbian & Gay Rights", 
                "R27: Patients' Rights<i>(Draft Code - not for internal IRS use)</i>", 
                "R28: Children's Rights", 
                "R29: Employee & Workers' Rights<i>(Draft Code - not for internal IRS use)</i>", 
                ...
                "R65: Freedom of Religion Issues<i>(Draft Code - not for internal IRS use)</i>", 
    ...
    CAUSES_AND_SERVICES = {
      ...
      "Community & Economic Development" => ["Business & Industry Development", "Community Coalitions", "Community Service Clubs", "Economic Development"], 
      "Children & Family Services" => ["Adoption Services", "Child Day Care", "Children & Family Services", "Domestic/Family Violence Shelters", "Family Counseling", "Foster Care", "Parenting Classes & Education", "Pregnancy Centers"], 
      "Disability Services" => ["Adult Day Care", "Centers for Blind & Visually Impaired People", "Centers for Deaf & Hearing Impaired People", "Centers for People with Developmental Disabilities", "Developmental Disability Services", "Disability Advocates/Alliance Organizations", "Disability Education & Awareness", "Disability Support/Caregivers", "Group Homes", "Medical Support Services", "Physical Rehabilitation", "Residential Care Programs", "Services to Promote the Independence of Specific Populations", "Spinal Cord Injuries & Musculoskeletal Disease Support", "Supportive Housing"], 
      "Disaster Relief & Preparedness" => ["Disaster Preparedness", "Disaster Relief Assistance for Businesses", "Disaster Relief Housing", "Disaster Relief Loans", "Disaster Relief Services", "Fire Prevention & Safety", "First Aid Education & Services", "Safety Education", "Search & Rescue Squads"], 
      "Drug & Alcohol Treatment" => ["Addiction & Recovery Services", "Crisis Intervention", "Detox Services", "Family & Friends Support Services", "Inpatient Services", "Long Term Recovery Residential Living", "Medication Assisted Treatment", "Outpatient Services", "Recovery Meetings", "Sober Living/Recovery Housing", "Substance Abuse Education & Prevention", "Substance Abuse Treatment", "Transitional Living"], 
      "Education" => ["Adult Education", "Libraries", "Parent & Teacher Groups", "Scholarships & Financial Aid", "Schools", "Special Education", "Student Educational Services", "Vocational & Technical"], 
      "Emergency & Safety" => ["Bullying & Youth Violence Prevention", "Child Abuse Services", "Consumer Protection", "Crime Prevention", "Domestic Violence Services", "Drunk Driving Related Classes & Prevention", "Elder Abuse Services", "Protection Against Abuse Services", "Sexual Assault Services"], 
      "Employment" => ["Employment Opportunities ", "Job Search Assistance", "Job Training", "Labor Unions", "Social Enterprises", "Vocational Counseling"], 
